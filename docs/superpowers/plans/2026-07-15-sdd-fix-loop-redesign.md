...
> adopts scoped re-review mechanics but does not adopt per-task reviews, fixed
> round breakers, forced fresh Implementers, or fixed model escalation. Current
> behavior is governed by `docs/ultra-fork.md` and the 2026-07-23 semantic
> integration design.
